...
type ShaderUniform = { value: number | THREE.Vector3 | THREE.Vector4 };
type UniformMap = {
  iTime: ShaderUniform;
  iResolution: ShaderUniform;
  iMouse: ShaderUniform;
  uWispDensity: ShaderUniform;
  uTiltScale: ShaderUniform;
  uFlowTime: ShaderUniform;
  uFogTime: ShaderUniform;
  uBeamXFrac: ShaderUniform;
  uBeamYFrac: ShaderUniform;
  uFlowSpeed: ShaderUniform;
  uVLenFactor: ShaderUniform;
  uHLenFactor: ShaderUniform;
  uFogIntensity: ShaderUniform;
  uFogScale: ShaderUniform;
  uWSpeed: ShaderUniform;
  uWIntensity: ShaderUniform;
  uFlowStrength: ShaderUniform;
  uDecay: ShaderUniform;
  uFalloffStart: ShaderUniform;
  uFogFallSpeed: ShaderUniform;
  uColor: ShaderUniform;
  uFade: ShaderUniform;
};
...
export const LaserFlow: React.FC<Props> = ({
  ...
  }, [dpr, wispDensity, mouseTiltStrength, horizontalBeamOffset, verticalBeamOffset, flowSpeed, verticalSizing, horizontalSizing, fogIntensity, fogScale, wispSpeed, wispIntensity, flowStrength, decay, falloffStart, fogFallSpeed]);
